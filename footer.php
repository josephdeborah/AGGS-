...
<head>
  ...
  <title> </title>
  <meta name="description" content=" home page of Anglican girls grammar school obalende ijebu-ode ogunstate nigeria ">
...
<body class="index-page">
  ...
  <footer id="footer" class="footer position-relative dark-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright ||</span> <strong class="px-1 sitename">Anglican Girls' Grammar School (A.G.G.S).</strong> <span>All Rights Reserved</span></p>
      <div class="credits">

        Designed by <a href="https://josephdeborahdebcodes.vercel.app">Debcodes</a>
      </div>
    </div>
